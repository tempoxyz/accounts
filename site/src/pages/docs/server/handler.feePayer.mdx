...
:::warning
`Handler.feePayer` has been deprecated. Use [`Handler.relay`](/docs/server/handler.relay) with the [`feePayer`](/docs/server/handler.relay#feepayer) option instead.
:::
...
See [`Handler.relay`](/docs/server/handler.relay) for the full API reference.
