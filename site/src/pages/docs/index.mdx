...
The Accounts SDK is a router between your application and a signing [Adapter](/docs/adapters) (e.g. the Tempo Wallet dialog), exposed as an [EIP-1193 Provider](https://eips.ethereum.org/EIPS/eip-1193).
...
| [Embed Domain-bound Passkeys](https://github.com/tempoxyz/accounts/tree/main/examples/domain-bound-webauthn)                | Domain-bound passkey example using Wagmi and the `webAuthn` connector.            | [Guide](/docs/guides/authentication)   |
...
| [Sponsor Fees + Tempo Wallets](https://github.com/tempoxyz/accounts/tree/main/examples/with-fee-payer)                      | Sponsor transactions via Tempo Wallets.                                           | [Guide](/docs/guides/fee-sponsorship)  |
| [Sponsor Fees + Domain-bound Passkeys](https://github.com/tempoxyz/accounts/tree/main/examples/with-fee-payer-and-webauthn) | Sponsor transactions via domain-bound Passkeys.                                   | [Guide](/docs/guides/fee-sponsorship)  |
