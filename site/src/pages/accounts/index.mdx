...
| Adapter | Description | 
| --- | --- |
| [**Tempo Wallet**](https://docs.tempo.xyz/guide/use-accounts/embed-tempo-wallet) | Delegates signing to [`wallet.tempo.xyz`](https://wallet.tempo.xyz) via an iframe dialog or popup. One passkey, one account, portable across apps. 
| [**Domain-bound Passkeys**](https://docs.tempo.xyz/guide/use-accounts/embed-passkeys) | The app (or wallet) handles passkey ceremonies and signing in-process on its own domain. 
...
<Cards>
  ...
  <Card
    ...
    to="https://docs.tempo.xyz/guide/stablecoin-dex"
...
| Example | Description | |
| --- | --- | --- |
| [Embed Tempo Wallet](https://github.com/tempoxyz/accounts/tree/main/examples/basic) | Wagmi-based setup using the `tempoWallet` connector to connect to Tempo Wallets. | [Guide](https://docs.tempo.xyz/guide/use-accounts/embed-tempo-wallet) |
| [Embed Domain-bound Passkeys](https://github.com/tempoxyz/accounts/tree/main/examples/domain-bound-webauthn) | Domain-bound passkey example using Wagmi and the `webAuthn` connector. | [Guide](https://docs.tempo.xyz/guide/use-accounts/embed-passkeys) |
...
| [Sponsor Fees + Tempo Wallets](https://github.com/tempoxyz/accounts/tree/main/examples/with-fee-payer) | Sponsor transactions via Tempo Wallets. | [Guide](https://docs.tempo.xyz/guide/payments/sponsor-user-fees) |
| [Sponsor Fees + Domain-bound Passkeys](https://github.com/tempoxyz/accounts/tree/main/examples/with-fee-payer-and-webauthn) | Sponsor transactions via domain-bound Passkeys. | [Guide](https://docs.tempo.xyz/guide/payments/sponsor-user-fees) |
