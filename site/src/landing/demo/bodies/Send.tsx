          ...
          {DESTINATIONS.map((d) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-between gap-3 border px-3 py-2.5 text-left outline-none focus-visible:outline-2 focus-visible:outline-info focus-visible:outline-offset-2 transition-colors duration-150 ${active ? "border-panel-edge bg-panel-4" : "border-transparent bg-panel-3"}`}
              >
