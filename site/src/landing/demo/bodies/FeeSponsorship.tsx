...
export function FeeSponsorshipBody(props: DemoBodyProps) {
  ...
  const buttonLabel =
    status === 'running' ? 'Sending...' : done ? 'Sponsored transfer sent' : 'Send without fees'
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="font-mono text-[28px] leading-none text-foreground">$1.00</p>
        </div>
      ...
      <div className="grid gap-2">
        ...
        {result?.feePayer ? (
          <div className="flex items-center justify-between bg-panel-3 px-4 py-3">
            ...
            <span className="font-mono text-[12px] text-foreground" title={result.feePayer}>
