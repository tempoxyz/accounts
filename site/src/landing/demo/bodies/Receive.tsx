 ...
 */
export const RECEIVE_FALLBACK_ADDRESS = '0x16214C64fa1230b8DDc4F8e29D7AdAfee8b0B171' as const

export function ReceiveBody({ address, delay }: { address: `0x${string}`; delay: number }) {
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex w-full items-center justify-between gap-3 border border-panel-edge bg-panel-3 px-3 py-2.5">
          <div className="flex min-w-0 flex-col gap-0.5">
            ...
            <span className="font-mono text-[11px] text-foreground-subtle">{shorten(address)}</span>
          </div>
        </div>
      </div>
