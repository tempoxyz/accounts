...
function activateOnKey(event: KeyboardEvent<HTMLButtonElement>, activate: () => void) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        ...
        <p className="text-[20px] leading-tight text-foreground">Choose your favorite style</p>
      </div>
        ...
        style={
          {
            ...
            '--theme-on-accent': 'oklch(from var(--theme-accent) clamp(0, (0.6 - l) * 999, 1) 0 0)',
      ...
      <div className="grid gap-3">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-2 pb-1.5" style={{ colorScheme: scheme }}>
              {ACCENTS.map((item) => {
