...
const NATIVE: Record<'orderPizza' | 'balancesDark' | 'clearInvoice' | 'reload', Palette> = {
  orderPizza: {
...
function Skeleton({ className, bg }: { className?: string; bg: string; delay?: number }) {
  return (
    <span
      aria-hidden
    ...
    <CardShell palette={palette}>
      <div className="flex flex-col">
        <div className="flex items-center justify-between pb-3">
          <p className="text-[12px] tracking-[0.1134px]" style={{ color: palette.headerColor }}>
            Order Pizza
          </p>
          <p className="text-[12px] tracking-[0.0992px]" style={{ color: palette.metaColor }}>
            View order
          </p>
        </div>
              ...
              <div key={i} className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Skeleton
                    ...
                    delay={i * 80}
                  />
                  <Skeleton className="h-3 w-14" bg={palette.skeleton} delay={i * 80 + 40} />
                </div>
                <Skeleton className="h-3 w-[46px]" bg={palette.skeleton} delay={i * 80 + 80} />
              </div>
            ))}
          </div>
        </div>
            ...
            <div key={i} className="flex items-center justify-between py-[3px]">
              <div className="flex items-center gap-2">
                <Skeleton
                  ...
                  delay={i * 120}
                />
                <Skeleton className="h-3 w-14" bg={palette.skeleton} delay={i * 120 + 80} />
              </div>
              <Skeleton className="h-3 w-[46px]" bg={palette.skeleton} delay={i * 120 + 160} />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-3 pb-2">
          <div className="flex h-[144px] items-start justify-between py-[3px]">
            ...
            <Skeleton className="h-3 w-[46px]" bg={palette.skeleton} delay={80} />
          </div>
          {[0, 1, 2].map((i) => (
            <div key={i} className="flex items-center justify-between py-[3px]">
              <div className="flex items-center gap-2">
...
function ReloadCard({ palette }: { palette: Palette }) {
  return (
    <CardShell palette={palette}>
      <div className="flex flex-col">
        <div className="flex items-center justify-between pb-3">
          <p className="text-[12px] tracking-[0.12px]" style={{ color: palette.headerColor }}>
            Reload Card
          </p>
          <p className="text-[12px] tracking-[0.0992px]" style={{ color: palette.metaColor }}>
            View all
...
function ThemeSwitcher({
  ...
  const presets: ThemePreset[] = ['Default', 'Minimal', 'Marketplace', 'Custom']
  return (
...
export default function Customize() {
  ...
  useEffect(() => {
    setCustom((prev) => (prev.scheme === resolved ? prev : { ...prev, scheme: resolved }))
  }, [resolved])
    ...
    >
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <p className="max-w-[600px] text-[18px] text-foreground-muted">
          Tempo Accounts SDK ships with full control on customizability to allow you to design embed
          like your native styles.
        </p>
        <div className="mt-5">
        ...
        <div
          ...
          style={{
            ...
            transform: theme === 'Custom' ? 'translateY(0)' : 'translateY(-8px)',
