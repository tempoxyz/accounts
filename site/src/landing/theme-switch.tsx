...
export function ThemeSwitch({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`grid size-7 place-items-center text-foreground outline-none focus-visible:outline-2 focus-visible:outline-info focus-visible:outline-offset-2 transition-opacity hover:opacity-75 focus-visible:opacity-75 ${className ?? ""}`}
    >
