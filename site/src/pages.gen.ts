...
type Page =
  ...
  | { path: '/docs/api/dialog.host.create'; render: 'static' }
  | { path: '/docs/api/dialog.host'; render: 'static' }
  | { path: '/docs/api/dialog.host.useEnsureVisibility'; render: 'static' }
  | { path: '/docs/api/dialog.host.useState'; render: 'static' }
  | { path: '/docs/api/dialog.host.useTheme'; render: 'static' }
  | { path: '/docs/api/dialog.host.validateSearch'; render: 'static' }
