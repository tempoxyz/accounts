...
type Page =
  ...
  | { path: '/docs/adapters/privy'; render: 'static' }
  ...
  | { path: '/docs/api/keystore'; render: 'static' }
  | { path: '/docs/api/keystore.p256'; render: 'static' }
  | { path: '/docs/api/keystore.secp256k1'; render: 'static' }
  | { path: '/docs/api/keystore.webCryptoP256'; render: 'static' }
  | { path: '/docs/api/local'; render: 'static' }
  | { path: '/docs/api/mobileWebAuth'; render: 'static' }
  | { path: '/docs/api/postMessage'; render: 'static' }
  ...
  | { path: '/docs/api/storage.asyncStorage'; render: 'static' }
  ...
  | { path: '/docs/api/storage.secureMmkv'; render: 'static' }
  ...
  | { path: '/docs/guides/identity'; render: 'static' }
  ...
  | { path: '/docs/server/identity.verify'; render: 'static' }
