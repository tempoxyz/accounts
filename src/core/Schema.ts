...
export const schema = from([
  ...
  Rpc.wallet_authorizeAdminKey.schema,
  ...
  Rpc.wallet_receivePolicy_burn.schema,
  Rpc.wallet_receivePolicy_claim.schema,
  Rpc.wallet_receivePolicy_get.schema,
  Rpc.wallet_receivePolicy_getBlockedBalance.schema,
  Rpc.wallet_receivePolicy_set.schema,
  Rpc.wallet_receivePolicy_validate.schema,
