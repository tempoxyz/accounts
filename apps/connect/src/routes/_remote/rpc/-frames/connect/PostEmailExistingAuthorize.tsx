...
/** Existing passkey found + authorize spend — log in and approve spending scopes. */
export function PostEmailExistingAuthorize(props: PostEmailExistingAuthorize.Props) {
    ...
    >
      <Frame>
        <Frame.Header
          ...
          subtitle={
            <>
              Log in with your passkey and allow <span className="text-foreground">{host}</span> to
              spend.
            </>
          }
...
export declare namespace PostEmailExistingAuthorize {
  type Props = {
